...
void GalderaErantzunenPantaillaSortu(int galderaID, GALDERA galdera[GELAIDMAX][GALDERAIDMAX]);
...
void galderakEtaEurenAukerakSortu(GALDERA galdera[][]) {
    ...
    while (gelaID <= 10) {
        ...
        while (galderaId <= 5) {
            ...
            {
            case 1:
                strcpy(galdera[gelaID][galderaId], "Zein da FOR baten sintaxia?");
