...
void KolisioakKonprobatu(void* pixels, int pitch, Uint8 bpp)
{
	...
	//////////////////////////////detectar el color//////////////////////////////
	hitbox.goikoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 66, sprite.pos.y + 0);		//Burua
	//Ezkerreko aldea
	hitbox.ezker.goikoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 46, sprite.pos.y + 11);

	hitbox.ezker.erdikoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 46, sprite.pos.y + 32);
	hitbox.ezker.behekoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 46, sprite.pos.y + 52);
	//Eskuineko aldea
	hitbox.eskuin.goikoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 82, sprite.pos.y + 11);
	hitbox.eskuin.erdikoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 82, sprite.pos.y + 32);
	hitbox.eskuin.behekoa = getpixel(pixels, pitch, bpp, sprite.pos.x + 82, sprite.pos.y + 52);
	//Behekoa
